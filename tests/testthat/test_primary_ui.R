...
test_that("primary_data_ui", {
  ...
  # create ui
  x <- primary_data_ui(site_names = site_names, feature_names = feature_names,
...
test_that("primary_results_ui", {
  ...
  # create ui
  x <- primary_results_ui(site_names = site_names,
...
test_that("primary_sidebar_ui", {
  ...
  # create ui
  x <- primary_sidebar_ui(site_names = site_names,
                          feature_names = feature_names,
                          action_names = action_names, parameters = parameters)
...
test_that("primary_map_ui", {
  ...
  # create ui
  x <- primary_map_ui(site_names = site_names,
                          feature_names = feature_names,
                          action_names = action_names, parameters = parameters)
